...
public class Neo4jMappingContextFactoryBean extends AbstractFactoryBean<Neo4jMappingContext> implements
	 ...
	 * @since 5.1.0
	 */
	Neo4jMappingContextFactoryBean(final String sessionFactoryBeanName) {
	...
	protected Neo4jMappingContext createInstance() {
		final SessionFactory sessionFactory = beanFactory.getBean(this.sessionFactoryBeanName, SessionFactory.class);
		final Neo4jMappingContext context = new Neo4jMappingContext(sessionFactory.metaData());
		context.initialize();
		return context;
	}
